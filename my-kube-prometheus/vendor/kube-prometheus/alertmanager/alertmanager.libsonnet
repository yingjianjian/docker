    ...
    alertmanager+:: {
      ...
      config: {
        global: {
          ...
          smtp_from: 'gitlab@qjdchina.com',
          smtp_auth_username: 'gitlab@qjdchina.com',
          smtp_auth_password: 'Wxy654321!@#',
        ...
        receivers: [
          {
            name: 'mail',
            email_configs: [{to: 'yingjianjian@qjdchina.com', require_tls: false,send_resolved: true}]
          },
        ],
      },
      replicas: 3,
